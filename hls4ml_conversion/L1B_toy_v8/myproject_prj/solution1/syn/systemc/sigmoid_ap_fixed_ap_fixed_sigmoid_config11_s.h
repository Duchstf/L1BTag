...
#ifndef _sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s_HH_
#define _sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s_sigmoid_table1.h"

namespace ap_rtl {

struct sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s : public sc_module {
    // Port declarations 9
    sc_in_clk ap_clk;
    ...
    // Module declarations
    sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s(sc_module_name name);
    SC_HAS_PROCESS(sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s);

    ~sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s();

    sc_trace_file* mVcdFile;

    sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s_sigmoid_table1* sigmoid_table1_U;
