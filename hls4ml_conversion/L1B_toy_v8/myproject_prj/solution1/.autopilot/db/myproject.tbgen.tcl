...
set C_modelArgList {
	{ conv1d_input_V int 2240 regular {pointer 0}  }
...
set portList { 
	...
	{ conv1d_input_V sc_in sc_lv 2240 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv1d_input_V", "direction": "in", "datatype": "sc_lv", "bitwidth":2240, "type": "signal", "bundle":{"name": "conv1d_input_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ret6_relu_ap_fixed_ap_fixed_16_8_5_3_0_relu_config7_s_fu_635", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "data_18_V_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "data_19_V_read", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ret8_relu_ap_fixed_ap_fixed_16_8_5_3_0_relu_config9_s_fu_659", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "data_8_V_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "data_9_V_read", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.layer10_out_0_V_dense_latency_ap_fixed_ap_fixed_config10_0_0_fu_673", "Parent" : "0",
...
set Spec2ImplPortList { 
	conv1d_input_V { ap_vld {  { conv1d_input_V in_data 0 2240 }  { conv1d_input_V_ap_vld in_vld 0 1 } } }
