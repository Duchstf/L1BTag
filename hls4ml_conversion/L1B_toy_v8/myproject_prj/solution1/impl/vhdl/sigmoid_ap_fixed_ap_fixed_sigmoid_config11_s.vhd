...
entity sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s is 
    ...
    component sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s_sigmoid_table1 IS
    generic (
        DataWidth : INTEGER;
...
begin
    sigmoid_table1_U : component sigmoid_ap_fixed_ap_fixed_sigmoid_config11_s_sigmoid_table1
    generic map (
        DataWidth => 10,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    sigmoid_table1_ce0_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
