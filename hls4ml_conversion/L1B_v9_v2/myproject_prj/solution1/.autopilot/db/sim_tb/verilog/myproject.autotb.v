...
`define AUTOTB_CLOCK_PERIOD_DIV2 1.25

`define AESL_DEPTH_conv1d_input_V 1
`define AESL_DEPTH_layer12_out_0_V 1
`define AESL_DEPTH_const_size_in_1 1
`define AESL_DEPTH_const_size_out_1 1
`define AUTOTB_TVIN_conv1d_input_V  "./c.myproject.autotvin_conv1d_input_V.dat"
`define AUTOTB_TVIN_conv1d_input_V_out_wrapc  "./rtl.myproject.autotvin_conv1d_input_V.dat"
`define AUTOTB_TVOUT_layer12_out_0_V  "./c.myproject.autotvout_layer12_out_0_V.dat"
...
`define AUTOTB_TVOUT_layer12_out_0_V_out_wrapc  "./impl_rtl.myproject.autotvout_layer12_out_0_V.dat"
...
parameter LENGTH_conv1d_input_V = 1;
...
wire ap_idle;
wire ap_ready;
wire [2079 : 0] conv1d_input_V;
wire  conv1d_input_V_ap_vld;
wire [15 : 0] layer12_out_0_V;
...
reg AESL_REG_conv1d_input_V_ap_vld;
// The signal of port conv1d_input_V
reg [2079: 0] AESL_REG_conv1d_input_V = 0;
assign conv1d_input_V = AESL_REG_conv1d_input_V;
assign conv1d_input_V_ap_vld = AESL_REG_conv1d_input_V_ap_vld;
initial begin : read_file_process_conv1d_input_V
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    AESL_REG_conv1d_input_V_ap_vld <= 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_conv1d_input_V,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_conv1d_input_V);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    read_token(fp, token);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            AESL_REG_conv1d_input_V_ap_vld <= 1;
            ret = $sscanf(token, "0x%x", AESL_REG_conv1d_input_V);
              if (ret != 1) begin
                  $display("Failed to parse token!");
                $display("ERROR: Simulation using HLS TB failed.");
                  $finish;
...
reg [15: 0] AESL_REG_layer12_out_0_V = 0;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.myproject.autotvout_layer12_out_0_V.dat", "r");
    fp2 = $fopen("./impl_rtl.myproject.autotvout_layer12_out_0_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myproject.autotvout_layer12_out_0_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myproject.autotvout_layer12_out_0_V.dat\"!");
    else begin
        $display("Comparing rtl.myproject.autotvout_layer12_out_0_V.dat with impl_rtl.myproject.autotvout_layer12_out_0_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_conv1d_input_V;
reg [31:0] size_conv1d_input_V;
reg [31:0] size_conv1d_input_V_backup;
