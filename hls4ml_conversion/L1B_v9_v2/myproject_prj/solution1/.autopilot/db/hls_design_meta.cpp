...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("conv1d_input_V", 2080, hls_in, 0, "ap_vld", "in_data", 1),
	Port_Property("conv1d_input_V_ap_vld", 1, hls_in, 0, "ap_vld", "in_vld", 1),
	Port_Property("layer12_out_0_V", 16, hls_out, 1, "ap_vld", "out_data", 1),
	Port_Property("layer12_out_0_V_ap_vld", 1, hls_out, 1, "ap_vld", "out_vld", 1),
