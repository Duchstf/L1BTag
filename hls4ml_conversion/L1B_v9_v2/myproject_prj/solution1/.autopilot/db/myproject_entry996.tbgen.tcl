set moduleName myproject_entry996
set isTopModule 0
...
set C_modelName {myproject.entry996}
set C_modelType { void 0 }
set C_modelArgList {
	{ conv1d_input_V int 2080 regular {fifo 0}  }
	{ conv1d_input_V_out int 2080 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv1d_input_V", "interface" : "fifo", "bitwidth" : 2080, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ conv1d_input_V_dout sc_in sc_lv 2080 signal 0 } 
	{ conv1d_input_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ conv1d_input_V_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv1d_input_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":2080, "type": "signal", "bundle":{"name": "conv1d_input_V", "role": "dout" }} , 
 	{ "name": "conv1d_input_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv1d_input_V", "role": "empty_n" }} , 
 	{ "name": "conv1d_input_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv1d_input_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "conv1d_input_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	conv1d_input_V { ap_fifo {  { conv1d_input_V_dout fifo_data 0 2080 }  { conv1d_input_V_empty_n fifo_status 0 1 }  { conv1d_input_V_read fifo_update 1 1 } } }
