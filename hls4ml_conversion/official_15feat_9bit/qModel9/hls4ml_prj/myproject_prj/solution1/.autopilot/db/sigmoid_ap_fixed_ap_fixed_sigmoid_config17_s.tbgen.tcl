set moduleName sigmoid_ap_fixed_ap_fixed_sigmoid_config17_s
set isTopModule 0
...
set C_modelName {sigmoid<ap_fixed,ap_fixed,sigmoid_config17>}
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "layer17_out_0_V", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "sigmoid_ap_fixed_ap_fixed_sigmoid_config17_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "sigmoid_table21", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sigmoid_table21_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	sigmoid_ap_fixed_ap_fixed_sigmoid_config17_s {
		empty {Type I LastRead 0 FirstWrite -1}
		layer17_out_0_V {Type O LastRead -1 FirstWrite 1}
		sigmoid_table21 {Type I LastRead -1 FirstWrite -1}}}
