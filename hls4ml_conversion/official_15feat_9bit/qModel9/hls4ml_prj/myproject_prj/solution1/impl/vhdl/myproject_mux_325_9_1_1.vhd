...
entity myproject_mux_325_9_1_1 is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of myproject_mux_325_9_1_1 is
    ...
    signal mux_1_8    : std_logic_vector(8 downto 0);
    signal mux_1_9    : std_logic_vector(8 downto 0);
    signal mux_1_10    : std_logic_vector(8 downto 0);
    signal mux_1_11    : std_logic_vector(8 downto 0);
    signal mux_1_12    : std_logic_vector(8 downto 0);
    signal mux_1_13    : std_logic_vector(8 downto 0);
    signal mux_1_14    : std_logic_vector(8 downto 0);
    signal mux_1_15    : std_logic_vector(8 downto 0);
    -- level 2 signals
    ...
    signal mux_2_4    : std_logic_vector(8 downto 0);
    signal mux_2_5    : std_logic_vector(8 downto 0);
    signal mux_2_6    : std_logic_vector(8 downto 0);
    signal mux_2_7    : std_logic_vector(8 downto 0);
    -- level 3 signals
    signal mux_3_0    : std_logic_vector(8 downto 0);
    signal mux_3_1    : std_logic_vector(8 downto 0);
    signal mux_3_2    : std_logic_vector(8 downto 0);
    signal mux_3_3    : std_logic_vector(8 downto 0);
    -- level 4 signals
    signal mux_4_0    : std_logic_vector(8 downto 0);
    signal mux_4_1    : std_logic_vector(8 downto 0);
    -- level 5 signals
    signal mux_5_0    : std_logic_vector(8 downto 0);
begin
